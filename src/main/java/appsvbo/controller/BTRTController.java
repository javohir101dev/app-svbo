...
//        List<Application Type> DB Field app_type
        ff2E.setDf8000(Arrays.asList(new DF8000("BTRT51")));
...
//        Account Transactions Flag
        ff8004.setDf8113(Arrays.asList(new DF8113("503401")));

//        Legal ID Type
        ff8004.setDf8114(Arrays.asList(new DF8114("500601")));
...
//        Position
        ff22.setDf800d(Arrays.asList(new DF800D("120800")));
...
//        Address Type:
        ff2A.setDf801e(Arrays.asList(new DF801E("ADDR0")));
...
//        Account Type
        ff36.setDf8035(Arrays.asList(new DF8035("502401")));
